...
import zhCn from 'farst/dist/locale/zh-cn.mjs'
...
```html
<script src="//unpkg.com/farst/dist/locale/zh-cn"></script>
<script>
  app.use(ElementPlus, {
...
[Supported Language List](https://github.com/farst/farst/tree/dev/packages/locale/lang)
...
If you need any other languages, [PR](https://github.com/farst/farst/pulls)
is always welcomed, you only need to add a language file at
[here](https://github.com/farst/farst/tree/dev/packages/locale/lang).
